...
class StartedCurrentOrderScreen extends StatefulWidget{
  @override
  StartedCurrentOrderScreenState createState() => StartedCurrentOrderScreenState();
}

class StartedCurrentOrderScreenState extends State<StartedCurrentOrderScreen>{
