  ...
  void _register() async {
    await MyApp.database.lock.synchronized(() async {
      final User user = (await
          MyApp.database.getAuth().createUserWithEmailAndPassword(
        email: email.text,
        ...
        child: Center(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(0, 20, 0, 0),
                child: _entryField('Confirm Password', confirmPassword, isPassword: true),
              ),
              Padding(
                padding: const EdgeInsets.fromLTRB(0, 20, 0, 0),
                        ...
                        if(isChecked) {
                          ...
                          await MyApp.database.lock.synchronized(() async {
                            if(_success){
                              ...
                              MyApp.database.insertCustomer(new Customer(phone.text, name.text, email.text, "", ""));
