...
import 'package:tie_service_provider_app/design_assets/editable_text_field.dart';
                ...
                PrimaryButton(
                  ...
                  callback: () async {
                    ServiceProvider customer =
                        await MyApp.database.getServiceProviderByEmail();
                    MyApp.database.updateServiceProvider(new ServiceProvider(
                        customer.id,
                        customer.name,
                        customer.email,
                        customer.imageUrl,
