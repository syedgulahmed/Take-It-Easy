...
import 'package:tie_service_provider_app/design_assets/profile_cards/progress_order_item_card.dart';
import 'package:tie_service_provider_app/design_assets/timeline_tile.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Container(
              child: (order.orderStage == OrderStatus.STARTED)
                  ? MainButton(
                      name: 'Finish',
                      color: Colors.blue,
                      widthSizePercent: 0.8,
                      ...
                      callback: () async {
                        ...
                        var d = DateTime.now();
                        order.setEndTime(d.day.toString() +
                            "-" +
                            d.month.toString() +
                            "-" +
                            d.year.toString() +
